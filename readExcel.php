...
$publicationsValidJSON = json_encode($publications, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_NUMERIC_CHECK);      // Returns the JSON representation of a value
$_SESSION['publications'] = $publicationsValidJSON;
